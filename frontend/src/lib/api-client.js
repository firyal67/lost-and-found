...
// In development, the Next.js dev proxy forwards /api → localhost:5000.
// In production, call the backend directly (CORS is configured on the backend).
const BASE_URL = DEV ? "/api" : "https://backend-service-production-ac47.up.railway.app/api";

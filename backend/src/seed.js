...
module.exports = async function seed() {
  ...
  const ahmed   = await ensureUser(usersCol, 'ahmed@example.com', 'Ahmed Ben Salem', 'User1234!', 'user');
  ...
  const allPosts = [
    ...
    { type: 'found', objectType: 'cin', title: "Carte d'identité trouvée à l'Ariana", description: 'CIN trouvé près du marché municipal.', city: 'Ariana', delegation: '', date: new Date('2026-07-18'), status: 'active', author: ahmed._id, contactEmail: 'ahmed@example.com', contactPhone: '+216 98 111 222', contactPreferences: { phone: true, email: false, platform: true }, maskedDocNumber: '****1234', reward: null, createdAt: new Date(), updatedAt: new Date() },
    ...
    { type: 'lost', objectType: 'permis', title: 'Permis de conduire perdu à Nabeul', description: 'Permis perdu dans la région de Dar Chaâbane.', city: 'Nabeul', delegation: 'Dar Chaâbane', date: new Date('2026-07-23'), status: 'active', author: ahmed._id, contactEmail: 'ahmed@example.com', contactPhone: '+216 98 111 222', contactPreferences: { phone: true, email: true, platform: true }, maskedDocNumber: '****9012', reward: 30, createdAt: new Date(), updatedAt: new Date() },
    ...
    { type: 'lost', objectType: 'telephone', title: 'iPhone 14 perdu à la Marsa', description: 'iPhone 14 violet avec coque en silicone rose. Perdu au café Cosy, avenue Habib Bourguiba.', city: 'Tunis', delegation: 'La Marsa', date: new Date('2026-07-19'), status: 'active', author: ahmed._id, contactEmail: 'ahmed@example.com', contactPhone: '+216 98 111 222', contactPreferences: { phone: true, email: true, platform: true }, maskedDocNumber: null, reward: 150, createdAt: new Date(), updatedAt: new Date() },
    ...
    { type: 'lost', objectType: 'tablette', title: 'iPad perdu dans le train Banlieue Sud', description: 'iPad Air 5e génération, gris sidéral, avec un clavier Logitech attaché. Perdu dans le train entre Tunis et Borj Cédria.', city: 'Tunis', delegation: 'Banlieue Sud', date: new Date('2026-07-24'), status: 'active', author: ahmed._id, contactEmail: 'ahmed@example.com', contactPhone: '+216 98 111 222', contactPreferences: { phone: false, email: true, platform: true }, maskedDocNumber: null, reward: 200, createdAt: new Date(), updatedAt: new Date() },
    ...
    { type: 'found', objectType: 'bijou', title: 'Bague en argent trouvée à Sousse', description: 'Bague en argent avec une pierre turquoise. Trouvée sur la plage de Port El Kantaoui.', city: 'Sousse', delegation: 'Port El Kantaoui', date: new Date('2026-07-28'), status: 'active', author: ahmed._id, contactEmail: 'ahmed@example.com', contactPhone: '+216 98 111 222', contactPreferences: { phone: true, email: true, platform: true }, maskedDocNumber: null, reward: null, createdAt: new Date(), updatedAt: new Date() },
    ...
    { type: 'found', objectType: 'ordinateur', title: 'PC portable trouvé à Gabès', description: 'HP Pavilion 15 noir, trouvé dans un café du centre-ville de Gabès.', city: 'Gabès', delegation: 'Ville', date: new Date('2026-07-30'), status: 'active', author: ahmed._id, contactEmail: 'ahmed@example.com', contactPhone: '+216 98 111 222', contactPreferences: { phone: true, email: true, platform: true }, maskedDocNumber: null, reward: null, createdAt: new Date(), updatedAt: new Date() },
  ];
